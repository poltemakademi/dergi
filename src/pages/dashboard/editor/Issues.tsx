import { Plus, Book, FileText, CheckCircle, Upload } from 'lucide-react';

const acceptedArticles = [
  { id: 'JMS-2025-030', title: 'Ethics in Artificial Intelligence', category: 'Opinion' },
  { id: 'JMS-2025-021', title: 'The Future of Renewable Energy Grids', category: 'Research Article' },
  { id: 'JMS-2025-015', title: 'Historical Analysis of Trade Routes', category: 'Review Article' },
];
    ...
    <div className="flex flex-col lg:flex-row gap-8 h-full">
      ...
      <div className="w-full lg:w-1/3 flex flex-col gap-4">
        <div className="flex items-center justify-between">
          ...
          <span className="bg-emerald-100 text-emerald-700 text-xs px-2 py-1 rounded-full font-bold">3 items</span>
        </div>
        
        <div className="bg-slate-100 rounded-2xl p-4 flex-1 overflow-y-auto space-y-3 border border-slate-200 border-dashed">
      ...
      <div className="flex-1 bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
        <div className="flex items-start justify-between border-b border-slate-100 pb-6 mb-6">
          ...
          <button className="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold flex items-center gap-2 shadow-lg shadow-indigo-600/20 transition-all">
            <CheckCircle className="w-4 h-4" /> Publish Issue
          </button>
        </div>
        ...
        <div>
          ...
          <div className="min-h-[200px] border-2 border-dashed border-slate-200 rounded-xl bg-slate-50 flex items-center justify-center flex-col text-slate-400">
